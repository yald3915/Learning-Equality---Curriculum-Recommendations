This file is the baseline code for Learning Equality - Curriculum Recommendations--Enhance learning by matching K-12 content to target topics

以上文件是Learning Equality - Curriculum Recommendations--Enhance learning by matching K-12 content to target topics（内容检索大赛）比赛的baseline代码
